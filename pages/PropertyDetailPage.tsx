                    ...
                    <ol className="inline-flex items-center space-x-1.5 sm:space-x-2 whitespace-nowrap min-w-0">
                        <li className="inline-flex items-center shrink-0">
                            <Link to="/" className="hover:text-accent transition-colors flex items-center">
                                <svg className="w-3.5 h-3.5 mr-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <li className="shrink-0">
                            <div className="flex items-center">
                                <svg className="w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 9 4-4-4-4"/></svg>
                                <Link to={`/immobilier-${slugifyCity(city)}`} className="hover:text-accent transition-colors ml-1">Immobilier {city}</Link>
                            </div>
                        </li>
                         <li aria-current="page" className="shrink-0">
                            <div className="flex items-center">
                                <svg className="w-3 h-3 text-gray-400 mx-1 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 9 4-4-4-4"/></svg>
                 ...
                 {imageUrls && imageUrls.length > 0 && ( 
                    <> 
                        <div className="md:hidden mt-6 print:hidden"> 
                            <div className="relative flex overflow-x-auto overflow-y-hidden snap-x snap-mandatory rounded-2xl shadow-md scrollbar-hide aspect-video bg-gray-900 touch-pan-x overscroll-x-contain select-none"> 
                                {thumbUrls.map((thumbUrl, index) => ( 
                                    <div key={index} className="snap-center snap-always w-full h-full flex-shrink-0 aspect-video relative group overflow-hidden bg-gray-900"> 
                                        <ImageWithSkeleton 
                                            src={thumbUrl} 
